...
screen -dmS crypt
screen -S crypt -X stuff  "/root/AutoRclone/autoClone/autoClone_cr.sh $5 $6 $7 $8 $9 ^M" 
# numer of drives to crypt: $5  from:$6  number of sa groups:$7 number of sa's:$8 bucket name from :$9
#screen -dmS  clone
