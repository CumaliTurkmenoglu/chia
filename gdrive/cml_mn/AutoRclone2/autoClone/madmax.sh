        ...
        if [ ! -z $MADMAX_PROCESS_ID ]
            then
                ...
                then
                        ...
                        screen -S tavuk -X stuff "./build/chia_plot -n -1 -r $5  -t /disk2/temp/ -d /disk2/plots/ -c xch1wxvh0lupku627a3qnnrggssr9ey4utcfmk87llvg94wgahemc2yq2u37za -f b87d02b56e479832e7414bd7a0d8c3b03f18947eb406d82c9b1de30fcbad012fb84fe7bbd0b335310bcfd344a8bd9e94 ^M"
        fi
