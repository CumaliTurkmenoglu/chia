...
do
        ...
        CLONE_PROCESS_ID=$(pgrep "INFO  : Starting transaction limiter:")
...
#                                               screen -S clone -X stuff  "/root/AutoRclone/autoClone/autoClone.sh $remote $transfer ^M"
                ...
                elif [ $MADMAX_STATUS == "T" ] && [ $PLOT_COUNT -lt 6 ]
                then
                ...
                then
                        ...
                        screen -S tavuk -X stuff "./bladebit -c xch1wxvh0lupku627a3qnnrggssr9ey4utcfmk87llvg94wgahemc2yq2u37za -f b87d02b56e479832e7414bd7a0d8c3b03f18947eb406d82c9b1de30fcbad012fb84fe7bbd0b335310bcfd344a8bd9e94 diskplot -t1 /disk2/temp/ /disk2/plots/ ^M"
        fi
